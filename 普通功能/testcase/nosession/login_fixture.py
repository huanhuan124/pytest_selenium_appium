...
def test_createVehicle(login_do):
    ...
    re = requests.post("http://carvmscoretest.zuche.com/carvmscore/vehiclemanage/readyrun/vehicleReadyRunVueController/createVehicle.do_",
                                json=mydata, headers=head)
    print(re.text)
